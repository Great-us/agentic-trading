"""Read-only Alpaca access for the dashboard, one reader per book.
...
protective stops live only at the broker. The dashboard therefore queries
Alpaca's paper REST API directly.
